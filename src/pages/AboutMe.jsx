    ...
    return (
        <div className="w-[90%] lg:max-w-[1280px] mx-auto">
            ...
            <div>
                ...
                <h1 className="text-center font-bold text-2xl my-2">Ali Ashraf Shakil</h1>
                <p className="text-center my-3 font-semibold">{"I'm a Data Analyst with over two years of experience"}</p>
                <div>
                    <p>
